...
const requestNotif = async (app, activate) => {
  ...
  if (permission == "denied") {
    return app.ports.gotFromSettings.send({ val: false, msg: "You have blocked browser notifications for this app. Change your in browser settings to allow new notifications."});
  }
  ...
  return app.ports.gotFromSettings.send({ val: false, msg: "You have blocked browser notifications for this app. Change your browser settings to allow notifications."});
}
